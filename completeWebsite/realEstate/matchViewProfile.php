						...
						<form id ="registrationForm" action="demo_form.asp" method="get" onsubmit="return validateCreateAccountForm();">
							<h1>Tenant Profile</h1>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Tenant Age: <?php echo $age;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Does the tenant smoke? <?php echo $smoke;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Tenant Wage: <?php echo $wage;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Tenant Occupation: <?php echo $occupation;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Inhabitants: <?php echo $inhabitants;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel">Tenant Pets:</label>
								</div>
							...
							<div id="submitButtonsdiv">
								...
								<input class="buttons" type="button" value="View Tenant Contact" onclick="location.href = 'matchViewContact.php';">
							</div>
