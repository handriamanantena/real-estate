						...
						<form id ="registrationForm" action="demo_form.asp" method="get" onsubmit="return validateCreateAccountForm();">
							<h1>Your Profile</h1>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Your Age: <?php echo $age;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Do you smoke?: <?php echo $smoke;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Your Wage: <?php echo $wage;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Your Occupation: <?php echo $occupation;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Inhabitants: <?php echo $inhabitants;?></label>
								</div>
								<div class = "forumdivisionAll">
									 <label class="propertyLabel">Your Pets:</label>
								</div>
