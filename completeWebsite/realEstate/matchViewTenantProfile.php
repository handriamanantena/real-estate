					...
					<div id= "forumcontainer">	
						<form id ="registrationForm" action="demo_form.asp" method="get" onsubmit="return validateCreateAccountForm();">
							...
							<div id="submitButtonsdiv">
								<input class="buttons" type="button" value="Next" onclick="location.href ='viewTenantCriteria.php';">
								<input class="buttons" type="button" value="Back" >
							</div>
