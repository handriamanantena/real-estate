					...
					<div id= "forumcontainer">	
						<form id ="registrationForm" action="demo_form.asp" method="get" onsubmit="return validateCreateAccountForm();">
							...
							<div class="infoBackground">
								<div class = "forumdivisionAll">
									 <label class="propertyLabel" >Title of your add: <?php echo $title;?></label>
								</div>
								<div class = "forumdivisionAll">
							...
							<div id="submitButtonsdiv">
								<input class="buttons" type="button" value="View Tenant Criteria" onclick="location.href ='viewOwnerSelectionCriteria.php';">
								<input class="buttons" type="button" value="Match Tenant" onclick = "location.href = 'algorithm/algorithm.php'">
							</div>
						</form>
