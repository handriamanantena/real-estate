...
<!DOCTYPE html>
	<html>
		...
		<body>	  
			...
			<main>
				<div id="content">
					<div><h1>Your Criteria For An Ideal Tenant</h1></div>
					<div id= "forumelements">	
						<form id ="registrationForm"  action="phpProcessFiles/processCriteriaAndProfile.php" method="post" onsubmit="return validateOwnerCriteriaForm();">
							<div class = "forumdivision">
								 <label for="fname">Tenant Age:</label>
								 <input type="text" id="age" name="inputedage" placeholder ="Tenant age" required="required" pattern="^[0-9]{1,3}$" title="Invalid age"> 
							</div>
							<div class = "forumdivision">
								<label for= "petoptions">Pets allowed:</label>
							...
							<div class = "forumdivision">
								<label for="smoker">Smokers okay?</label>
								<select required="required" id="smokerOptions" name="smoke">
									<option value="smokeyes">Yes</option>
									<option value="smokeno">No</option>
								</select>
							</div>
							<div class = "forumdivision">
								<label for="salary">Minimum Wage:</label>
								<select id="occupationoptions" name="wage">	
							...
							<div class = "forumdivision">
								...
								<select id="paymentMethod" name="payMethod">	
									...
									<option value="perMonthonth">Per Month</option>
									<option value="perBiYear">Bimonthly</option>
